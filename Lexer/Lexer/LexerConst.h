...
{ "bool", "keyword" },{ "string", "keyword" },{ "char", "keyword" },
{ "void", "keyword" },{ "class", "keyword" },{ "public", "keyword" },
{ "private", "keyword" },{ "protected", "keyword" },{ "final", "keyword" },
{ "static", "keyword" },{ "try", "keyword" },{ "catch", "keyword" },
{ "finally", "keyword" },{ "while", "keyword" },{ "if", "keyword" },
{ "for", "keyword" },{ "do", "keyword" },{ "throw", "keyword" },
{ "throws", "keyword" },{ "new", "keyword" },{ "delete", "keyword" },
{ "return", "keyword" },{ "struct", "keyword" },{ "enum", "keyword" },
{ "true", "boolean" },{ "false", "boolean" },{ "+", "operator" },
...
{ "/=", "operator" },{ "==", "operator" },{ "!=", "operator" },
{ "<=", "operator" },{ ">=", "operator" },{ "?", "operator" },
{ "++", "operator" },{ "--", "operator" },{ "\"", "string quote" },
{ "\'", "char quote" },{ ";", "semicolon" },{ ",", "comma" },
{ ":", "colon" },{ "(", "opening bracket" },{ ")", "closing bracket" },
{ "[", "opening square bracket" },{ "]", "closing square bracket" },{ "{", "opening block bracket" },
{ "}", "closing block bracket" },{ "//", "line comment" },{ "/*", "opening block comment" },
{ "*/", "closing block comment" },{ "NULL", "keyword" },{ "null", "keyword" },{ ".", "dot" }
};

static const std::string INT_TOKEN = "int";
